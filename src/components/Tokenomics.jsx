...
<div className="token-section flex flex-row w-full items-center p-2">
    <h4 className='w-1/2 text-center text-4xl text-[#59C09D] md:text-2xl sm:text-xl'>Total Suppy</h4>
    <p className='w-1/2 text-center text-2xl'>2000Cr </p>
</div>

<div className="token-section flex flex-row w-full items-center p-2">
    <h4 className='w-1/2 text-center text-4xl text-[#59C09D] md:text-2xl sm:text-xl'>Every event</h4>
    <p className='w-1/2 text-center text-2xl'> 5% burn </p>
</div>

<div className="token-section  flex flex-row w-full items-center p-2">
    <h4 className='w-1/2 text-center text-4xl text-[#59C09D] md:text-2xl sm:text-xl'>Total Burn</h4>
...
<div className="token-section  flex flex-row w-full items-center p-2">
    <h4 className='w-1/2 text-center text-4xl text-[#59C09D] md:text-2xl sm:text-xl'>Airdrop</h4>
    <p className='w-1/2 text-center text-2xl'>20%</p>
</div>

<div className="token-section  flex flex-row w-full items-center p-2">
    <h4 className='w-1/2 text-center text-4xl text-[#59C09D] md:text-2xl sm:text-xl'>Honor holding</h4>
    <p className='w-1/2 text-center text-2xl'>10%</p>
</div>

<div className="token-section  flex flex-row w-full items-center p-2">
    <h4 className='w-1/2 text-center text-4xl text-[#59C09D] md:text-2xl sm:text-xl'>Exchange</h4>
    <p className='w-1/2 text-center text-2xl'>10%</p>
</div>
</div>
